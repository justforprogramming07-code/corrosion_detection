...
::: {#91d42c50 .cell execution_count=3}
``` {.python .cell-code}
...
::: {#5cd7b7a1 .cell execution_count=4}
``` {.python .cell-code}
path = Path('Data/data')
```
:::
...
::: {#8f257220 .cell quarto-private-1='{"key":"colab","value":{"base_uri":"https://localhost:8080/","height":730}}' outputId='c33b0b4f-8380-4ec4-d2dc-6fee9717c2bb' execution_count=5}
``` {.python .cell-code}
size = 224
bs = 32
...
![](00_core_files/figure-html/cell-6-output-2.png){}
:::
:::
...
::: {#cb79739f .cell quarto-private-1='{"key":"colab","value":{"base_uri":"https://localhost:8080/"}}' outputId='49b5b2a1-8dc2-479b-a361-bc2e1333787a' execution_count=7}
``` {.python .cell-code}
...
::: {#e8b4a1b5 .cell quarto-private-1='{"key":"colab","value":{"base_uri":"https://localhost:8080/","height":302}}' outputId='6f24a381-7b87-44ac-9888-759d92e585d2' execution_count=8}
``` {.python .cell-code}
learn.fine_tune(4)
...
::: {.cell-output .cell-output-display}
```{=html}
<div><table class="fastprogress"><thead><tr><th>epoch</th><th>train_loss</th><th>valid_loss</th><th>accuracy</th><th>time</th></tr></thead><tbody><tr><td>0</td><td>0.593704</td><td>0.269474</td><td>0.925620</td><td>06:18</td></tr></tbody></table></div>
```
:::

::: {.cell-output .cell-output-display}
```{=html}
<div><table class="fastprogress"><thead><tr><th>epoch</th><th>train_loss</th><th>valid_loss</th><th>accuracy</th><th>time</th></tr></thead><tbody><tr><td>0</td><td>0.286005</td><td>0.204621</td><td>0.939394</td><td>09:25</td></tr><tr><td>1</td><td>0.248296</td><td>0.220989</td><td>0.942149</td><td>09:19</td></tr><tr><td>2</td><td>0.170603</td><td>0.123218</td><td>0.958678</td><td>09:11</td></tr><tr><td>3</td><td>0.111802</td><td>0.124969</td><td>0.961433</td><td>08:56</td></tr></tbody></table></div>
```
:::
...
::: {#15201108 .cell quarto-private-1='{"key":"colab","value":{"base_uri":"https://localhost:8080/","height":490}}' outputId='1c1fd4a5-4bf1-429b-9754-5f2a554e3b62' execution_count=9}
``` {.python .cell-code}
learn.recorder.plot_loss()
```

::: {.cell-output .cell-output-display}
![](00_core_files/figure-html/cell-9-output-1.png){}
:::
:::
...
::: {#8bae8136 .cell quarto-private-1='{"key":"colab","value":{"base_uri":"https://localhost:8080/","height":67,"referenced_widgets":["a429be167a8a46979bf6332fde8e5f94","5208939f470f416c98250fc606257ce4","e1dc89b968b6468c909f6b6fa5fc9ed2"]}}' outputId='d03ec917-2794-44bb-b71a-a8c0ef066c4b' execution_count=12}
``` {.python .cell-code}
...
{"model_id":"a429be167a8a46979bf6332fde8e5f94","version_major":2,"version_minor":0,"quarto_mimetype":"application/vnd.jupyter.widget-view+json"}
</script>
```
:::
:::
...
::: {#6e71b324 .cell quarto-private-1='{"key":"colab","value":{"base_uri":"https://localhost:8080/","height":72}}' outputId='cd0b8205-5281-48a7-9f18-86a1d90930e6' execution_count=14}
``` {.python .cell-code}
...
::: {#10bc9029 .cell quarto-private-1='{"key":"colab","value":{"base_uri":"https://localhost:8080/","height":917}}' outputId='3fc8425a-be5c-4599-e22a-531a3b5a5605' execution_count=15}
``` {.python .cell-code}
import random
...
::: {.cell-output .cell-output-display}
![](00_core_files/figure-html/cell-12-output-2.png){}
:::
:::
